...
class AppConfig {
  ...
  static const String appVersion = "v0.9.0-Beta";
  ...
  static const List<Map<String, dynamic>> changelogData = [
    {
      ...
      'changes': [
        ...
        'CALLS: Улучшена обработка состояний звонка (Dialing, Incoming, Connecting, Connected).',
        'CALLS: Настроены параметры обработки аудио (echo cancellation, noise suppression).',
        'UI: Полностью переработанный экран звонка с анимациями и визуализацией аудио волн.',
        'UI: Добавлены кнопки управления микрофоном и динамиком с визуальной обратной связью.',
        'UI: Отображение длительности звонка в реальном времени.',
        'SERVER: Улучшена обработка офлайн сообщений для звонков.',
        'SERVER: Автоматическая очистка офлайн сообщений звонка при завершении.',
