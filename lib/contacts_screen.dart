...
class _ContactsScreenState extends State<ContactsScreen> {
  ...
  @override
  void initState() { super.initState(); _refreshContacts(); }
  void _refreshContacts() { setState(() { _contactsFuture = DatabaseService.instance.getContacts(); }); }
  ...
  void _showMyIdDialog() {
    ...
    showDialog(context: context, builder: (context) => AlertDialog(
      ...
      actions: [
        TextButton(child: const Text('Копировать'), onPressed: () {
  ...
  void _showDeleteContactDialog(Contact contact) {
    showDialog(context: context, builder: (context) => AlertDialog(
      ...
      actions: [
        TextButton(onPressed: () => Navigator.pop(context), child: const Text('Отмена')),
        TextButton(child: const Text('Удалить', style: TextStyle(color: Colors.red)), onPressed: () async {
          if (!mounted) return;
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    ...
                    child: Text(contact.name[0].toUpperCase(), style: TextStyle(fontSize: 24,
